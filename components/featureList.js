...
export default function FeatureList() {
  return (
    <div className="container mx-auto max-w-5xl py-6 flex gap-12 flex-wrap items-start justify-center md:justify-between">
      <div className="flex flex-row gap-4 items-center text-center md:flex-1">
        <div className="">
