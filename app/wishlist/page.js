      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          ...
          <div className="mt-6">
            <Link
              href="/"
              className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-[#129160] hover:bg-[#a03680] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
