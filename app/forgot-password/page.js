...
// Компонент с използване на useSearchParams
...
// Обхващаме компонента, използващ useSearchParams със Suspense
function SuccessMessage({ email, resetAction }) {
  return (
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="mt-8 space-y-6">
          ...
          <div className="text-center space-y-4">
            ...
            <Suspense
              fallback={
                <div className="py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-gray-400">
                  Зареждане...
                </div>
              }
            >
...
export default function ForgotPasswordPage() {
  ...
  if (state?.success) {
    return <SuccessMessage email={state.email} resetAction={resetAction} />;
  }
  ...
  return (
    <div className="flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          <p className="text-sm text-gray-600">
            <Link href="/login" className="font-medium text-[#129160]">
              Обратно към входа
            </Link>
          </p>
        </div>
...
function SubmitButton() {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md bg-[#129160] hover:bg-[#ebedeb] text-white hover:text-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 cursor-pointer"
    >
